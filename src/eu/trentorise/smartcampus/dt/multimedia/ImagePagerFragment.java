...
public class ImagePagerFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.ac_image_pager, container, false);
	}
	...
	public void onStart() {
		super.onStart();
		String[] imageUrls = getArguments().getStringArray(Extra.IMAGES);
		int pagerPosition = getArguments().getInt(Extra.IMAGE_POSITION, 0);
