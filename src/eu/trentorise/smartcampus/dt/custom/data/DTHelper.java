...
public class DTHelper {
	...
	public static String getUserId() {
		UserData data = getAccessProvider().readUserData(instance.mContext, null);
		if (data != null) {
	...
	public static void follow(BaseDTObject event, String idTopic) throws ConnectionException, ProtocolException,
			SecurityException, DataException, RemoteException, StorageConfigurationException {
		MessageRequest request = new MessageRequest(GlobalConfig.getAppUrl(getInstance().mContext), Constants.SERVICE
				+ "/objects/" + event.getId() + "/follow");
		request.setMethod(Method.PUT);
	...
	public static String[] getImageURLs(Long objectId) throws JsonParseException, JsonMappingException, IOException,
			ConnectionException, ProtocolException, SecurityException, ParseException, DataException {
