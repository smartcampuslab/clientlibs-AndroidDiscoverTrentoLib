...
public class SearchFragment extends FeedbackFragment {
	...
	public void onStart() {
		...
		sendBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				fragmentTransaction.replace(R.id.fragment_container, fragment, type);
	...
	public void onResume() {
		...
		if (!isonline) {
			new AlertDialog.Builder(getSherlockActivity()).setTitle(R.string.dialog_connectivity_title)
