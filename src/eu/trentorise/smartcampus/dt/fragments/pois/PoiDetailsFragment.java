...
public class PoiDetailsFragment extends NotificationsSherlockFragmentDT {
	...
	public void onStart() {
		...
		if (getPOI() != null) {
			...
			if (CategoryHelper.FAMILY_CATEGORY_POI.equals(getPOI().getType())
					&& isCertified(getPOI())) {
			...
			tv.setText(Html.fromHtml("<a href=\"\">" + poi.shortAddress()
					+ "</a> "));
...
>>>>>>> branch '2013-06-11_crazy_week' of git@github.com:smartcampuslab/android.discovertrento.lib.git
...
=======
			...
			try {
				...
				Log.e(EventDetailsFragment.class.getName(), String.format(
						"Error unfollowing event %s", getPOI().getEntityId()));
			}
			return true;
